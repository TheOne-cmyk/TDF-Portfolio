    ...
    return (
      <section id="contact" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center bg-white p-12 rounded-2xl shadow-lg max-w-3xl mx-auto">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                    ...
                    {socialLinks.map((social, index) => {
                      ...
                      return (
                        <a
                          ...
                          className={`w-12 h-12 bg-gray-100 text-gray-600 rounded-lg flex items-center justify-center hover:text-white transition-all duration-200 ${social.color}`}
                ...
                <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                  <h4 className="font-semibold text-blue-900 mb-2">Disponibilité</h4>
