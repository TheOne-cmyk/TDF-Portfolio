...
const Hero = () => {
  ...
  return (
    <section id="accueil" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-50 to-white py-4 lg:py-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8 xl:gap-12">
          ...
          <div className="w-full lg:w-7/12 xl:w-8/12 text-center lg:text-left">
            <div className="mb-4 lg:mb-6">
              <div className="inline-block px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium mb-3 lg:mb-4">
                Développeur Full-Stack
              </div>
              
              <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-2 lg:mb-3">
                <span className="text-blue-600 block">Tsobgou Dongmo</span>
                <span className="text-gray-800 text-2xl md:text-3xl lg:text-4xl xl:text-5xl">Francis Warren</span>
              </h1>
              ...
              {/* Description concise */}
              <p className="text-gray-600 text-sm lg:text-base max-w-2xl mx-auto lg:mx-0 mb-4 lg:mb-6">
            ...
            <div className="flex justify-center lg:justify-start gap-3 lg:gap-4 mb-6 lg:mb-8">
              <div className="bg-white p-2 lg:p-3 rounded-lg shadow-sm border border-blue-100 flex flex-col items-center min-w-[80px] lg:min-w-[90px]">
            ...
            <div className="flex flex-row sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#projets"
                className="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-200 group shadow-md hover:shadow-lg"
              >
                Voir mes projets
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center px-6 py-3 border border-blue-600 text-blue-600 font-medium rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-200 shadow-sm hover:shadow-md"
              >
              ...
              <a
                href="/cv.pdf"
                className="inline-flex items-center justify-center px-6 py-3 bg-white text-gray-800 font-medium rounded-lg hover:bg-gray-50 transition-all duration-200 border border-gray-200 shadow-sm hover:shadow-md"
                target="_blank"
          ...
          <div className="w-full lg:w-5/12 xl:w-4/12 flex justify-center relative mt-4 lg:mt-0">
            <div className="relative w-full max-w-xs lg:max-w-sm">
              ...
              <div className="bg-white rounded-xl p-5 shadow-lg border border-blue-100 transform transition-all duration-500 hover:shadow-md z-20 relative">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-3">
                    <h2 className="text-lg lg:text-xl font-bold text-gray-900">TDFW</h2>
                ...
                <div className="mb-4">
                  <h3 className="text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wide">Expertise</h3>
                  <div className="flex flex-wrap gap-1">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full">React</span>
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full">PHP</span>
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full">PostgréSQL</span>
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full">Tailwind</span>
                  </div>
                </div>
                ...
                <div className="flex justify-center gap-2 pt-3 border-t border-blue-100">
                  <a href="#" className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center shadow-sm hover:shadow-md transition-all duration-300 hover:bg-blue-100 group">
              ...
              <div className="absolute -top-3 -right-3 w-20 h-20 bg-blue-100 rounded-xl opacity-30 z-10 animate-float" style={{ animationDelay: '1.5s' }}></div>
              ...
              <div className="absolute -bottom-5 right-2 lg:-bottom-6 lg:right-3 bg-white p-1 lg:p-2 rounded border border-blue-100 transform rotate-3 z-30 shadow-sm">
